print("Esta en deeplab_resnet/model.py")
...
print("Esta en deeplab_resnet/model.py. 1) Va a hacer from kaffe.tensorflow import Network")
from kaffe.tensorflow import Network
print("Esta en deeplab_resnet/model.py. 2) Va a hacer import tensorflow as tf")
...
class DeepLabResNetModel(Network):#Extiende clase Network
    ...
    def setup(self, is_training):
        ...
        #self.assadasdads.sadsa = 1#Esto me tira el error AttributeError: 'DeepLabResNetModel' object has no attribute 'assadasdads'
        
        #Al usar self, me dice que es un 'DeepLabResNetModel' object
        #self.feed('safkjds') #'Unknown layer name fed: safkjds'

        print(self.feed('data'))#Esto lo acepta bien


        #(self.feed('data')#Parece que .feed('data' tiene dimensiones 3,3,3,21
        #     .conv(7, 7, 64, 2, 2, biased=False, relu=False, name='conv1')
         #    )
             ...
             #)
        #(self.feed('bn2a_branch1','bn2a_branch1')
        #     .add(name='fc1_voc12'))

        #(self.feed('conv1')
        #     .conv(1, 1, 256, 2, 2, biased=False, relu=False, name='res2a_branch1'))
